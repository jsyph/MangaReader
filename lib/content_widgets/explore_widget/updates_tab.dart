...
import 'package:manga_reader/core/core_types/core_types.dart';

class RecentUpdatesTab extends StatelessWidget {
  final List<MangaSearchResult> _updatesManga;
  final String _mangaSourceName;

  const RecentUpdatesTab(
      this._updatesManga, this._mangaSourceName,
      {super.key});
